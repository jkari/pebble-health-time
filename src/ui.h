...
#define ACTIVITY_PROGRESS_WIDTH PBL_IF_ROUND_ELSE(12, 10)
#define ACTIVITY_SIZE_X PBL_IF_ROUND_ELSE(138, 106)
#define ACTIVITY_SIZE_Y PBL_IF_ROUND_ELSE(138, 128)
