...
#define MARKER_SIZE_X PBL_IF_ROUND_ELSE(170, 136)
#define MARKER_SIZE_Y PBL_IF_ROUND_ELSE(170, 160)
#define ACTIVITY_PROGRESS_SIZE_X PBL_IF_ROUND_ELSE(180, 144)
#define ACTIVITY_PROGRESS_SIZE_Y PBL_IF_ROUND_ELSE(180, 168)
#define ACTIVITY_PROGRESS_WIDTH PBL_IF_ROUND_ELSE(12, 6)
#define ACTIVITY_SIZE_X PBL_IF_ROUND_ELSE(138, 102)
#define ACTIVITY_SIZE_Y PBL_IF_ROUND_ELSE(138, 122)
#define SLEEP_SIZE_X PBL_IF_ROUND_ELSE(152, 116)
#define SLEEP_SIZE_Y PBL_IF_ROUND_ELSE(152, 136)
...
#define BLUETOOTH_OFFSET_X PBL_IF_ROUND_ELSE(57, 52)
